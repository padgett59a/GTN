...
GO
/****** Object:  StoredProcedure [dbo].[[SP_Trx_Sem]]    Script Date: 12/7/2021 12:32:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SP_Trx_Sem] 
	@langID int,
	@semCode varchar(16),
...
begin
	insert into semesters values (@semCodeE, @langID)
end
...
Begin
	insert into courses
	select value, @langID from dbo.SplitCSVs(@corsCodes)
End
Else
Begin
...
begin
	...
	--D.semesterCode = @semCode and 
	C.courseCoreID = D.courseCoreID and 
	B.sessionCoreID = C.sessionCoreID
...
--begin tran
--exec  [SP_Trx_Sem] 18, 'o', 1
--exec  [SP_Trx_Sem] 18, NULL, '2,94,133,141,293', 1
